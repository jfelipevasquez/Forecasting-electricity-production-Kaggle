...
This is an a Kaggle competition wich the aim  is to create a model that is uniquely capable of monitoring and analysing weather data to produce a plant-level production forecast. <br>
